...
def generate_building_sequence(box_size, box_height, stl_model, output_file,plot_name=None, plotting=True):
    ...
    my_sliced_mesh, dt = make_slice(your_mesh, box_size,box_height)
...
if __name__ == '__main__':
    ...
    # for file in files:
    for i in range(10):
        generate_building_sequence(box_size, box_height, f'{working_dir}{file}.stl',
                                   f'{working_dir}sequences/{file}_{box_size}.txt',
                                   plot_name=f'{working_dir}/{file}_{box_size}.png',
                                   plotting=True)